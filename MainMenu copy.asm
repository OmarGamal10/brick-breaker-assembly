...
.data
    ...
    ; Main Menu Variables
    PUBLIC LIVES_COUNT
    TITLE_VARIABLE db "BRICK BREAKER a7aa7a7- MAIN MENU$"
    ...
    X_SENDER db 0 ; x position of sending initial will be 0
    X_RECEIVE db 0 ; x position of receiving initial will be 0
    Y_RECEIVE db 0Dh ; y position of receiving initial will be D because of lower part of screen
.stack 100h
.code
    ; bar procedures
    EXTRN DRAW_BAR:NEAR, CLEAR_BAR:NEAR, WAIT_FOR_VSYNC:NEAR, HANDLE_MULTIPLAYER_GAME:FAR
...
SET_CURSOR_PROC proc far ; Set cursor at position x in dl and y in dh
    mov ah, 2
    int 10h
    ret
